import {
  ...
  useSlotProps
} from "./chunk-6ISIG7HW.js";
import {
  Typography_default
} from "./chunk-ALAWTDKB.js";
import {
  useTheme
} from "./chunk-6U6YUKOJ.js";
import {
  require_react_dom
} from "./chunk-ZW7WJ6XU.js";
import {
  shouldForwardProp
} from "./chunk-6LIWFVJ5.js";
import {
  HTMLElementType,
  chainPropTypes,
  exactProp,
...
} from "./chunk-QJX74QQQ.js";
import {
  setRef,
  useForkRef,
  useId
} from "./chunk-HGTFQX6Q.js";
import {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime7.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      const offset2 = isReveresed ? 1 - x2 / size : x2 / size;
      return (0, import_jsx_runtime7.jsxs)(React18.Fragment, {
...
function useChartGradient() {
  ...
  return React20.useCallback((axisId, direction) => `${chartId}-graient-${direction}-${axisId}`, [chartId]);
}
...
var ChartContainer = React21.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  const svgRef = React21.useRef(null);
  const handleRef = useForkRef(ref, svgRef);
  useReducedMotion2();
  return (0, import_jsx_runtime10.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime10.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime10.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime10.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime10.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime10.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime10.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var ResponsiveChartContainer = React24.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded2);
  const [containerRef, width, height] = useChartContainerDimensions(inWidth, inHeight);
  return (0, import_jsx_runtime11.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime11.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function ChartsText(props) {
  ...
  return (0, import_jsx_runtime12.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime12.jsx)("tspan", {
      x: x2,
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React27.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React28.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
    ...
    children: [!disableLine && (0, import_jsx_runtime14.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime14.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime14.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime14.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
true ? ZAxisContextProvider.propTypes = {
   ...
   */
  zAxis: import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types13.default.shape({
    classes: import_prop_types13.default.object,
    getColor: import_prop_types13.default.func,
    ...
    series: import_prop_types13.default.object,
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axisValue: import_prop_types14.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types15.default.shape({
    ...
    axisValue: import_prop_types15.default.any,
...
//# sourceMappingURL=chunk-PTPNUZCF.js.map
